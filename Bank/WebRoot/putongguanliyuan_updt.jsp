...
function check()
{
  ...
  String id=request.getParameter("id");
   %>
  <form name="form1" id="form1" method="post" action="putongguanliyuan_updt_post.jsp?id=<%=id %>">
  修改普通管理员:
  <br><br>
  <%
