...
String sql="update putongguanliyuan set gonghao='"+gonghao+"',xingming='"+xingming+"',mima='"+mima+"',bumen='"+bumen+"',dianhua='"+dianhua+"',shenfenzheng='"+shenfenzheng+"',zhaopian='"+zhaopian+"',xingbie='"+xingbie+"',beizhu='"+beizhu+"' where gonghao= '"+request.getSession().getAttribute("username")+"'";
connDbBean.executeUpdate(sql);
out.print("<script>alert('ÐÞ¸Ä³É¹¦!!');location.href='putongguanliyuan_updt2.jsp';</script>");
%>
  </body>
</html>
